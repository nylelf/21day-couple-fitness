...
import { buildActivityHintForProfile } from "./activitySchedule.js";
...
说明：
- activitySchedule 的 challengeDay 必须与上方「系统已从原文解析」一致，不得遗漏
- 用户可能写「周五周日打篮球」「周五打篮球；周日打篮球」等，系统已按日历星期换算挑战日
