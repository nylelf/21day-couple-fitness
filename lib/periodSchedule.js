...
/**
 * First predicted period start ON OR AFTER challenge start.
 * lastPeriodDate = day 1 of the most recent period (already ended); we do NOT re-apply that window.
 */
...
/**
 * Challenge days 1–21 that fall on predicted period days 1–5 (next period and later cycles only).
 */
